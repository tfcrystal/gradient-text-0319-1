...
# LR tables (lrs/*.json) and ratio/grpo_ratio.json aligned with 1st-place specs for
# instruct/DPO/GRPO; eval: lower test_loss wins for instruct/DPO, higher score for GRPO.
